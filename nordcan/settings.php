<?php
	...
	$conf = [
        ...
        'y' => [
            ...
            2018 => [
                ...
                'ages' => [ 'N0_4','N5_9','N10_14','N15_19','N20_24','N25_29','N30_34','N35_39','N40_44','N45_49','N50_54','N55_59','N60_64','N65_69','N70_74','N75_79','N80_84','N85'] , 
                ...
                'grouped_cancers' => [ 
                    ...
                    [
                        'cancer' => 42 , 
                        'label' =>  'Lip, oral cavity, salivary glands' , 
                        'ids' => [1,2] , 
                        'ICD'   => 'C00-08',
                        'color' => '#AE563E'
                    ] */
	...
	$get_cancer		= ( isset($_GET['cancer']) ) ? $_GET['cancer'] : 51 ;
    $get_population	= ( isset($_GET['population'])) ? $_GET['population'] : 0 ;
    ...
    $get_years  = ( isset($_GET['years']) && !empty( $_GET['years'] )) ? $_GET['years'] : '' ;
    $get_year_start  = ( isset($_GET['year_start']) && !empty( $_GET['year_start'] )) ? $_GET['year_start'] : '' ;
    $get_year_end  = ( isset($_GET['year_end']) && !empty( $_GET['year_end'] )) ? $_GET['year_end'] : '' ;

    $get_cohort  = ( isset($_GET['cohort']) && !empty( $_GET['cohort'] )) ? true : false ;
